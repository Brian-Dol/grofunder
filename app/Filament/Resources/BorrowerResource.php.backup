        ...
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('mobile_number')
                    ...
                    ->prefixIcon('heroicon-o-phone')
                    ->hint('Format: +256701234567 (unique identifier for farmer)')
                    ->unique()
                    ->nullable(),
                Forms\Components\Select::make('cooperative_id')
                    ...
                    ->preload()
                    ->nullable()
                    ->hint('Assign farmer to a cooperative for agent management'),
                ...
                SpatieMediaLibraryFileUpload::make('profile_picture')
                    ->label('Borrower Profile Picture')
                    ->disk('borrowers')
                    ...
                    ->imageEditor()
                    ->maxSize(2048)
                    ->helperText('Upload borrower profile picture (max 2MB)')
                    ->columnSpan(2),
