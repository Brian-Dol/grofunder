...
<x-filament-panels::page>
    ...
    <div class="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <ul class="text-sm text-blue-800 space-y-1">
            ...
            <li>✓ {{ __('Required columns: borrower_mobile_number, loan_number, principal_amount, interest_rate, loan_term_months, loan_status') }}</li>
            <li>✓ {{ __('Disbursement date is optional (defaults to today)') }}</li>
            <li>✓ {{ __('Loan status must be one of: pending, approved, completed, defaulted') }}</li>
            <li>✓ {{ __('Borrower must exist (lookup by mobile number)') }}</li>
            <li>✓ {{ __('Loan numbers must be unique per borrower') }}</li>
            <li>✓ {{ __('Duplicate loans will be skipped') }}</li>
