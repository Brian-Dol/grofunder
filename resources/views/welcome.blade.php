      ...
      <div class="header__wrapper">
        ...
        <nav class="c-nav">
          ...
          <div class="c-nav__content">
            ...
            <a href="{{ 'admin/login' }}" class="c-button c-button--primary"
              style="color:white; text-decoration:none;">Sign In</a>
  ...
  <style>
    ...
    @media (max-width: 768px) {
      .c-hero__button-group {
        ...
        align-items: center;
        gap: 12px;
        /* Replaces the <br> with better spacing */
      }

      .c-button {
        width: 100%;
        max-width: 200px;
        /* Limits width but keeps buttons sizable */
      }
    }
  </style>
  <main>
        ...
        <div class="container">
          <div class="c-hero__content">
            ...
            <h4 class="heading heading--4 heading--blue">
              Lendfy is a loan management software that helps lenders automate workflows, reduce manual work, and launch
              new products with ease.
            </h4>
            <div class="c-hero__button-group">
              ...
              <a href="{{ 'admin/register' }}" class="c-button c-button--secondary"
                style="color:white; text-decoration:none; display: inline-block; min-width: 120px; min-height: 44px; padding: 12px 24px; margin: 8px 0;">
                Sign Up
              </a>
            </div>
      ...
      <div class="container">
        <div class="section__title-wrapper">
          ...
          <h4 class="heading heading--4">
            Go beyond automation with intelligent underwriting. Our system performs instant credit scoring and risk
            assessment for each applicant, then automatically generates and sends personalized loan offers, agreements,
            and payment reminders. Make smarter, data-driven lending decisions without adding to your workload.
          </h4>
        </div>
        ...
        <div class="box box--flex">
          <article class="c-card">
            <div class="c-card__content">
              ...
              <p class="c-paragraph c-card__text">
                Lendfy was built with ease of use in mind. Take a look at the user interface for LendFy and you will be
                sure to understand where the difference lies.
              </p>
            </div>
          ...
          <article class="c-card">
            <div class="c-card__content">
              ...
              <p class="c-paragraph c-card__text">
                Give customers instant reports to the status of their loan details, repayment schedules, and application
                statuses
              </p>
            </div>
            <div class="c-card__img-holder">
          ...
          <article class="c-card">
            <div class="c-card__content">
              ...
              <p class="c-paragraph c-card__text">
                Pre-configured loan agreement templates, settlements, and workflows are available to simplify loan
        ...
        <div class="box box--grid">
          <article class="c-feature">
            ...
            <div class="c-feature__content">
              ...
              <p class="c-paragraph c-feature__text">
                LendFy, with its built-in CRM also comes with built-in accounting service tools like expense management
          ...
          <article class="c-feature">
            ...
            <div class="c-feature__content">
              ...
              <p class="c-paragraph c-feature__text">
                LendFy is a cloud-based hosted service. There is no need for you to have a website, servers or configure
                databases to start using our system.
              </p>
            </div>
          </article>
          ...
          <article class="c-feature">
            ...
            <div class="c-feature__content">
              ...
              <p class="c-paragraph c-feature__text">
                If your business has a website you can integrate it with LendFy to receive applications over API.
                Alternatively, if you don’t have a website we can always help you build one.
              </p>
            </div>
          </article>
        </div>
    ...
    <section class="section" id="pricing">
      <div class="container">
        <div class="section__title-wrapper">
          ...
          <h4 class="heading heading--4">
            LendFy is a SAAS platform and our pricing model is based on your growth. It starts from $45 per month and
