...
<head>
    <meta charset="utf-8">
    <title>Agent Report - {{ $cooperative->name }}</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>{{ $cooperative->name }} - Performance Report</h1>
    ...
    <div class="section">
        ...
        <div class="metric-row">
            <span class="metric-label">Cooperative Name:</span>
            <span class="metric-value">{{ $cooperative->name }}</span>
        </div>
        <div class="metric-row">
            <span class="metric-label">Region:</span>
            <span class="metric-value">{{ $cooperative->region ?? 'N/A' }}</span>
        </div>
        <div class="metric-row">
            <span class="metric-label">Status:</span>
            <span class="metric-value">{{ ucfirst($cooperative->status) }}</span>
        </div>
        <div class="metric-row">
            <span class="metric-label">Contact Email:</span>
            <span class="metric-value">{{ $cooperative->contact_email ?? 'N/A' }}</span>
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="metric-row">
            ...
            <span class="metric-value">{{ $repayment_metrics['on_time_repayments'] }}</span>
        </div>
        <div class="metric-row">
            <span class="metric-label">Overdue Repayments:</span>
            <span class="metric-value">{{ $repayment_metrics['overdue_repayments'] }}</span>
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="metric-row">
            <span class="metric-label">Completed Transactions:</span>
    ...
    <div class="section">
        ...
        <div class="metric-row">
            <span class="metric-label">New Borrowers (This Month):</span>
            <span class="metric-value">{{ $borrower_metrics['new_borrowers_this_month'] }}</span>
        </div>
        <div class="metric-row">
